...
#Load Data#
###########
data_raw<-read.csv("C:/Users/dougl/Desktop/comp-syn/algorithmic_bias/Data/NCOMM/Google_Wiki_data_main.csv")
...
###############################
IMDBceleb<-read.csv("C:/Users/dougl/Desktop/comp-syn/algorithmic_bias/Data/NCOMM/imdb_age_celeb.csv")
...
####################################
wikiceleb<-read.csv("C:/Users/dougl/Desktop/comp-syn/algorithmic_bias/Data/NCOMM/wiki_age_celeb.csv")
...
############################
CADC<-read.csv("C:/Users/dougl/Desktop/comp-syn/algorithmic_bias/Data/NCOMM/CACD.csv")
...
####Figure 2####
################
IP_data<-read.csv("C:/Users/dougl/Desktop/comp-syn/algorithmic_bias/Data/NCOMM/Google_IP_test_final.csv",na.string ="")
...
############################################
google_trends_freq<-read.csv("C:/Users/dougl/Desktop/comp-syn/algorithmic_bias/Data/NCOMM/Google_Search_Frequency_data.csv")
...
##########################################
uncropped<-read.csv("C:/Users/dougl/Desktop/comp-syn/algorithmic_bias/Data/NCOMM/Google_uncropped.csv")
...
#######################################
IP_data_clean_simp<-IP_data_clean %>% dplyr::select(Social.Category, IP ,face_id,image_id, WorkerId, Img.Age, Img.Gender)
